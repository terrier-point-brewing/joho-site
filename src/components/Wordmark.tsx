...
export function Wordmark() {
  ...
  return (
    <div className="select-none text-center">
      <div className="font-display text-5xl uppercase tracking-display-wide text-indigo-ink sm:text-6xl md:text-7xl">
        {wordmark.line1}
      </div>
      <div className="mt-3 font-body text-sm uppercase tracking-display text-indigo-ink sm:text-base">
        {line2Rest}
        <span className="text-seal-red">{line2Period}</span>
      </div>
    </div>
  );
}
